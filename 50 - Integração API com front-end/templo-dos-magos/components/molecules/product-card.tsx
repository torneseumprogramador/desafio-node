...
export function ProductCard({ product, onAddToCart, className }: ProductCardProps) {
  ...
  const colorClass = "from-cyan-500 to-blue-600 border-cyan-300"
  ...
  return (
    ...
    >
      ...
      <div className="p-4 flex flex-col items-center">
        ...
        <h3 className="text-xl font-bold text-white mb-2 text-center">{product.nome}</h3>
        <p className="text-2xl font-bold text-yellow-300 mb-4">R${Number(product.preco).toFixed(2)}</p>
        ...
        <Button
          ...
          onClick={() => onAddToCart(product.nome)}
        >
          ADICIONAR
        </Button>
      </div>
